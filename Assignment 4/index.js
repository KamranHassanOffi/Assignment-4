...
// quesrtion 4
function bankAction(userIndex, action, amount, targetIndex) {
  switch (action) {
    case "deposit":
...
console.log(bankAction(0, "deposit", 200));       
console.log(bankAction(1, "withdraw", 300));      
console.log(bankAction(0, "transfer", 100, 1));   
console.log(bankAction(1, "checkBalance"));       
...
console.log(convertCurrency(100, "JPY"));
